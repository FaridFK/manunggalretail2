...
// Mendapatkan data tb_project
$projectData = $dbConnector->getProjects();
...
<mso:Order msdt:dt="string">167700.000000000</mso:Order>
                    ...
                    <div class="col-xl-4 col-md-6 grid-item <?php echo $project['tipe_pekerjaan']; ?>">
                        ...
                        <div class="features-thumb bg-cover" style="background-image: url('admin/<?php echo $project['foto']; ?>')"></div>
                            <div class="content">
                                ...
                                <a href="project-details.php?id_project=<?php echo $project['id_project']; ?>">Read more <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>

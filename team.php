...
// Mendapatkan data tb_partner
$partnerData = $dbConnector->getPartners();
...
<mso:Order msdt:dt="string">170300.000000000</mso:Order>
                ...
                <?php foreach ($membersData as $member) : ?>
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="single-team-member">
                            <div class="member-img bg-cover bg-center" style="background-image: url('<?php echo "admin/pages/". $member['foto']; ?>')">
                            </div>
                            <div class="member-bio">
                                <h4><a href="team-details.php?id=<?php echo $member['id_member']; ?>"><?php echo $member['nama_member']; ?></a></h4>
                                <p><?php echo $member['nama_team']; ?></p>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                foreach ($partnerData as $partner) {
                    ...
                    echo '<div class="icon">';
                    echo '<img src="admin/' . $partner['foto'] . '" alt="partner" width="200">';
                    echo '</div>';
                    echo '<h4>' . $partner['nama_partner'] . '</h4>';
                    echo '<a href="' . $partner['link'] . '">go to <i class="fas fa-arrow-right"></i></a>';
                    echo '</div>';
                    echo '</div>';
                }
                ?>

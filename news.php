...
<mso:Order msdt:dt="string">169600.000000000</mso:Order>
                    ...
                    <div class="blog-posts">
                        <?php foreach ($newsData as $news): ?>
                            <div class="single-blog-post">
                                <div class="post-featured-thumb bg-cover" style="background-image: url('admin/pages/<?php echo $news['foto']; ?>')"></div>
                                <div class="post-content">
                                    <h2><a href="news-details.php?id=<?php echo $news['id_news']; ?>"><?php echo $news['judul_news']; ?></a></h2>
                                    <div class="post-meta">
                                        <!-- <span><i class="fal fa-eye"></i>232 Views</span> -->
                                        <!-- You may add more details here based on your data -->
                                        <span><i class="fal fa-calendar-alt"></i><?php echo $news['tanggal']; ?></span>
                                    </div>
                                    <p><?php echo substr($news['keterangan'], 0, 100) . '...'; ?></p>
                                    <div class="d-flex justify-content-between align-items-center mt-30">
                                        <div class="post-link">
                                            <a href="news-details.php?id=<?php echo $news['id_news']; ?>"><i class="fal fa-arrow-right"></i> Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
